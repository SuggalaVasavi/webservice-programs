...
.container {
    ...
    <body style="align:center" bgcolor="#999999">
    <center>
        <form action="REST/WebService/login" method="post" >
   ...
   <span>Update user!! <a href="update.jsp">Register Here</a></span><br>
    <span>Delete user!! <a href="delete.jsp">Register Here</a></span>
  </div>
</fieldset>
        </form>
        </center>
